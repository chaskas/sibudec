...
use Sibudec\AdminBundle\Entity\Source;
use Sibudec\AdminBundle\Form\SourceType;
...
class SourceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SibudecAdminBundle:Source')->findAll();
     ...
     * @Method("POST")
     * @Template("SibudecAdminBundle:Source:new.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("SibudecAdminBundle:Source:edit.html.twig")
     */
