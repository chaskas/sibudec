...
use Sibudec\AdminBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
     ...
     * @Method("POST")
     * @Template("SibudecAdminBundle:Category:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_category_edit', array('id' => $entity->getId())));
        }
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('SibudecAdminBundle:Category')->find($id);
     ...
     * @Method("PUT")
     * @Template("SibudecAdminBundle:Category:edit.html.twig")
     */
