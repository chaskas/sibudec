...
use Sibudec\AdminBundle\Entity\Department;
use Sibudec\AdminBundle\Form\DepartmentType;
...
class DepartmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SibudecAdminBundle:Department')->findAll();
     ...
     * @Method("POST")
     * @Template("SibudecAdminBundle:Department:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SibudecAdminBundle:Department')->find($id);
     ...
     * @Method("PUT")
     * @Template("SibudecAdminBundle:Department:edit.html.twig")
     */
