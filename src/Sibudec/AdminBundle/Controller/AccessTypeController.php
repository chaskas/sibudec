...
class AccessTypeController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_accesstype_show', array('id' => $entity->getId())));
        }
    ...
    /**
     * Finds and displays a AccessType entity.
     *
     * @Route("/{id}", name="admin_accesstype_show")
     * @Method("GET")
     * @Template()
     */
